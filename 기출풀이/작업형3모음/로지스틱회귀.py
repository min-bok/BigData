...
# Q. age + booked로 적합해야되는거 아님? 근데 답지는 age + service + booked임, 2번과 3번 문제 정답도 service이고..
# model = logit("target ~ age + service + booked", data=a).fit()
# print(model.pvalues.idxmax())
# print(model.params.iloc[1:].idxmax())
...
# 5) 422.6203967264441✅
# 6) 0.05475575748985911⭐ 해설지답은 -2.904872756182284
# 7) 1.292605228739193✅
# 8) 0.765✅
# 9) 0.235✅