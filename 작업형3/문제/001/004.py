...
# print(shapiro(df["Caffeine(mg)"])) # 0.9322031137746971
# print(0.9322031137746971 < 0.05) # 정규성 만족

stats, pvalue = ttest_1samp(df["Caffeine(mg)"], 95, alternative="less")
# print(stats, pvalue) # -5.501737036221897 5.8686553916715e-06

# print(1.1737310783343e-05 < 0.05)

# 윌콕슨 부호 검정 연습 (만약 정규성 불만족시)
# print(wilcoxon(df["Caffeine(mg)"] - 95, alternative="less"))
