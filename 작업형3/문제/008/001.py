...
# print(round(model.params["Intercept"],4), round(model.params["할인율"],4), round(model.params["온도"],4), round(model.params["광고비"],4))

new = pd.DataFrame({"할인율": [10], "온도": [20], "광고비": [500]})
# print(model.predict(new)) # 706.739338
...
# 10) 신뢰 구간: 614.507283 769.907488 
#     예측 구간: 395.622293 988.792478⭐
# 11) 귀무가설 기각 ⭐